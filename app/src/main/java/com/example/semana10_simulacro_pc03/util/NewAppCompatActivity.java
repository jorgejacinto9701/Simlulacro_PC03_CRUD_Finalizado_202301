...
import com.example.semana10_simulacro_pc03.ClienteCrudListaActivity;
...
public class NewAppCompatActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.idMenuCrudCliente){
            Intent intent = new Intent(this, ClienteCrudListaActivity.class);
